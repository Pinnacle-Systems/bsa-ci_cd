...
import {
  add_requestLeave,
  get__per,
  get_Current_Fin_Year,
  get_Lcode,
  get_leave_available,
  get_lcode_leave_available,
  getDocId,
  getLeaves,
  InsertLeave,
  requestLeave_Approval,
} from "../services/LeaveData.service.js";
...
router?.get("/get_lcode_leave_available", get_lcode_leave_available);
