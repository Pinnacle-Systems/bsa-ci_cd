import {
  COMPCODE,
  DYED_FABRIC_PURCHASE_INWARD_VIEW_ID,
  GYPI_CODE,
  DFPI_CODE,
  DYPI_CODE,
  ACC_PURCHASE_INWARD_VIEW_ID,
  API_CODE,
  DPB_CODE,
  PROJECTID,
  YARN_PURCHASE_BILL_ENTRY_VIEW_ID,
  YARN_PURCHASE_INWARD_VIEW_ID,
  YPB_CODE,
  GFPI_CODE,
  DYEDYARN_PURCHASE_INWARD_VIEW_ID,
  DYEDYARN_PURCHASE_BILL_ENTRY_VIEW_ID,
  GREY_FABRIC_PURCHASE_INWARD_VIEW_ID,
  DYED_FABRIC_PURCHASE_BILL_ENTRY_VIEW_ID,
  DFPB_CODE,
  GREY_FABRIC_PURCHASE_BILL_ENTRY,
  GFPB_CODE,
  ACC_PURCHASE_BILL_ENTRY_VIEW_ID,
  APB_CODE,
  YARN_PROCESS_RECEIPT_VIEW_ID,
  YREC_CODE,
  KNITTING_PROCESS_RECEIPT_VIEW_ID,
  KREC_CODE,
  DFPR_CODE,
  FABRIC_PROCESS_RECEIPT_VIEW_ID,
  YPRB_CODE,
  YARN_PROCESS_BILL_ENTRY_VIEW_ID,
  KNITTING_PRO_BILL_ENTRY_VIEW_ID,
  KPB_CODE,
  FABRIC_PRO_BILL_ENTRY_VIEW_ID,
  DFPROB_CODE,
...
export async function getNextGreyYarnPoInwardNo(connection) {
  const { finyearCode, finYearId } =
    await getCurrentFinancialYearIdAndCode(connection);
