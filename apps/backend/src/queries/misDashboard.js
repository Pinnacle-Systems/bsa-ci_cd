...
export async function getEmployees1(
  connection,
  type = "Value",
  filterYear,
  filterBuyer,
...
export async function getProfit1(
  connection,
  type = "YEAR",
  filterYear,
  filterBuyer,
...
export async function getLoss01(
  connection,
  type = "YEAR",
  filterYear,
  filterBuyer,
...
export async function getLoss1(
  connection,
  type = "YEAR",
  filterYear,
  filterBuyer,
...
export async function getLoss11(
  connection,
  type = "YEAR",
  filterYear,
  filterBuyer,
